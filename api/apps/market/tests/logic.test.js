...
function createMockRedis() {
    const store = {}, sets = {}, zsets = {}, counters = {};
    return {
        ...
        multi() {
            ...
            const p = {
                ...
                zAdd(k, { score, value }) { ops.push(() => { if (!zsets[k]) zsets[k] = new Map(); zsets[k].set(value, score); }); return p; },
                zRem(k, v) { ops.push(() => { if (zsets[k]) zsets[k].delete(v); }); return p; },
