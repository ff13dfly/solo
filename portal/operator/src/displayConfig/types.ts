// Display Protocol (docs/protocol/zh/display.md) — operator-side types.
// An EntityDisplay manifest declares how an entity renders. It is resolved from:
//   ① schema (introspection, read-only)  ← ② operator config (static base ← administrator override)  ← ③ personal prefs
// Presentation lives in operator; data services only publish schema/semantics.
...
/** Scope key shared with the view-mode + personal-field memory. */
