...
import WorkflowDenyModal from './WorkflowDenyModal';

import type { Workflow, CategoryConfig } from '../../types';
...
export default function WorkflowManagement() {
  ...
  void setError; void setServiceUrl; void error; void serviceUrl; void setIsServiceError;
  ...
  const handleDenyConfirm = async (reason: string) => {
    if (!denyModal) return;
    try {
      await callRpc('orchestrator.workflow.deny', { id: denyModal.id, reason });
